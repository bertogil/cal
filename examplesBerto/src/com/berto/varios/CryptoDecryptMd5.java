 ...
 */
public class CryptoDecryptMd5 {

	public static void main(final String[] args) {
		final String iv = "0123456789123456"; // This has to be 16 characters
		final String secretKey = "BaPX1h3hOoro4T43mch0fEGtv5AQ3v/";
		final CryptoDecryptMd5 crypto = new CryptoDecryptMd5();

		final String encryptedData = crypto.encrypt("This is a test message.",
				iv, secretKey);
		System.out.println(encryptedData);

		final String decryptedData = crypto.decrypt(encryptedData, iv,
				secretKey);
