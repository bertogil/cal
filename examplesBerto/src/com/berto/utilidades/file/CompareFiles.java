...
public class CompareFiles {
	public static void main(String[] args) throws IOException {
		...
		BufferedInputStream fis1 = new BufferedInputStream(new FileInputStream("c:/temp/log.log"));
		BufferedInputStream fis2 = new BufferedInputStream(new FileInputStream("c:/temp/log-copia.log"));
		int b1 = 0, b2 = 0, pos = 1;
		while (b1 != -1 && b2 != -1) {
			if (b1 != b2) {
